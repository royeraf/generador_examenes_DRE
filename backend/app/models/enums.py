...
MODULO_ADMIN_DESEMPENOS = "admin_desempenos"
...
_DRE_MODULOS = [
    ...
    MODULO_METRICAS, MODULO_ADMIN_DESEMPENOS, MODULO_ADMIN_UGELES,
    MODULO_ADMIN_INSTITUCIONES, MODULO_ADMIN_USUARIOS,
]

# Módulos habilitados por defecto según rol (cuando permisos_modulos es NULL)
ROLE_MODULOS_DEFAULT: dict[str, List[str]] = {
    RolCodigo.ESPECIALISTA_DRE_COMUNICACION: _DRE_MODULOS,
    RolCodigo.ESPECIALISTA_DRE_MATEMATICA: _DRE_MODULOS,
