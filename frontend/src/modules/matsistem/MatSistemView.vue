    ...
    <Navbar title="MatSistem" subtitle="Matemática práctica con IA" :show-home="true">
      <template #center>
        <div class="flex items-center bg-white dark:bg-[#252525] rounded-full p-1 border border-slate-300 dark:border-slate-700 shadow-sm overflow-x-auto flex-nowrap [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <button @click="activeTab = 'generador'" class="shrink-0 px-3 sm:px-4 py-1.5 rounded-full text-xs font-medium transition-all cursor-pointer" :class="activeTab === 'generador' ? 'bg-indigo-500 text-white shadow' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'">Generador</button>
          <button @click="activeTab = 'historial'" class="shrink-0 px-3 sm:px-4 py-1.5 rounded-full text-xs font-medium transition-all flex items-center gap-1.5 cursor-pointer" :class="activeTab === 'historial' ? 'bg-indigo-500 text-white shadow' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'">Historial <span v-if="history.length" class="text-[10px] bg-slate-200 dark:bg-[#393939] text-slate-800 dark:text-white px-1.5 rounded-full">{{ history.length }}</span></button>
        ...
        <aside v-show="isDesktop || mobileTab === 'config'" class="flex-1 lg:flex-none shrink-0 bg-white dark:bg-[#252525] rounded-xl flex flex-col overflow-hidden border border-slate-300 dark:border-slate-700 relative transition-all duration-200" :style="isDesktop ? { width: configCollapsed ? '88px' : col1Width + 'px' } : {}">
          ...
          <div v-show="!configCollapsed" class="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6">
            ...
            <div class="space-y-3">
              ...
              <div class="grid grid-cols-2 gap-2">
                <button
                    ...
                    :class="selectedCompetenciaId === comp.id ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-500/10' : 'border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-[#0d0d0d] hover:border-slate-300'">
            ...
            <div class="space-y-3">
              ...
              <input type="text" v-model="contenidoTematico" placeholder="Ej: fracciones, geometría..." class="w-full bg-slate-50 dark:bg-[#393939] border border-slate-300 dark:border-slate-600 rounded-xl py-2.5 px-3.5 text-xs font-bold text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all placeholder-slate-400" />
              ...
              <div class="pt-2">
                ...
                <div v-if="useTextoBase" class="space-y-2">
                    <div v-if="selectedFiles.length === 0 && !uploadingFile" class="relative">
                        ...
                        <div class="flex items-center justify-center py-2 px-3 bg-slate-50 dark:bg-[#0d0d0d] border border-dashed border-slate-300 dark:border-slate-600 rounded-xl hover:border-indigo-400 transition-all duration-300">
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center gap-3 bg-slate-50 dark:bg-[#0d0d0d] p-3 rounded-xl border border-slate-300 dark:border-slate-700">
                <input type="range" v-model.number="cantidadPreguntas" min="1" max="20" class="flex-1 h-1 bg-slate-200 dark:bg-[#393939] rounded-full appearance-none accent-indigo-500" />
          ...
          <div class="bg-white dark:bg-[#252525] rounded-2xl w-full max-w-md shadow-2xl border border-slate-300 dark:border-slate-600 flex flex-col">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <div v-else-if="codigosClaseMat.length === 0" class="text-xs text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-[#252525] rounded-xl px-4 py-3 border border-slate-300 dark:border-slate-700">
                  No tienes aulas activas. Crea una primero en la sección Aulas.
                </div>
                <template v-else>
                  <select v-model="codigoClaseIdMat" class="w-full bg-slate-50 dark:bg-[#393939] border border-slate-300 dark:border-slate-600 rounded-xl py-2.5 px-3.5 text-sm font-bold text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all appearance-none cursor-pointer">
                  ...
                  <p v-if="codigoClaseSeleccionadoMat" class="mt-1.5 text-[11px] text-slate-400 dark:text-slate-500 flex items-center gap-1">
