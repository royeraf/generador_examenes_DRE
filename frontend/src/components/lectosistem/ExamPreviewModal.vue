...
<template>
    <Teleport to="body">
        <Transition name="modal">
            <div v-if="entry" class="fixed inset-0 z-50 flex items-center justify-center p-4"
                ...
                <div
                    ...
                    <!-- Header -->
                    <div
                        class="bg-gradient-to-r from-amber-400 via-amber-500 to-orange-500 px-5 py-4 flex-shrink-0">
                        <div class="flex items-center justify-between gap-3">
                            <div class="flex items-center gap-3 min-w-0 flex-1">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div class="flex items-center gap-3 text-xs text-amber-100 mt-0.5">
                            ...
                            <div class="overflow-x-auto rounded-xl border-2 border-gray-100 dark:border-slate-700">
                                <table class="w-full text-sm">
                                    ...
                                    <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                                        <tr v-for="fila in entry.resultado.examen.tabla_respuestas" :key="fila.pregunta"
                    ...
                    <div
                        ...
                        <button @click="emit('eliminar')"
                            class="px-4 py-2.5 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl text-sm font-bold flex items-center gap-2 transition-colors">
