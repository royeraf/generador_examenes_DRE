...
const getTablaRow = (n: number): FilaTablaRespuestas | undefined =>
    props.entry?.resultado.examen.tabla_respuestas.find(t => t.pregunta === n);
...
<template>
                        ...
                        <template v-else-if="entry">
                            ...
                            <div
                                ...
                                <MathText as="p"
                                    ...
                                    :text="(entry.resultado.examen as any).situacion_problematica || entry.resultado.examen.lectura" />
                            </div>
    ...
    <!-- ── Sub-modal retroalimentación (z-60 sobre el modal z-50) ── -->
    <Teleport to="body">
...
.retro-enter-active, .retro-leave-active { transition: opacity 0.15s ease; }
.retro-enter-active .relative, .retro-leave-active .relative { transition: transform 0.15s ease, opacity 0.15s ease; }
.retro-enter-from, .retro-leave-to { opacity: 0; }
.retro-enter-from .relative { transform: scale(0.96) translateY(6px); opacity: 0; }
</style>
