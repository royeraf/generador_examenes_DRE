...
MODULO_GESTION_ESTUDIANTES = "gestion_estudiantes"
...
ROLE_MODULOS_DEFAULT: dict[str, List[str]] = {
    ...
    RolCodigo.RESPONSABLE_UGEL: [MODULO_METRICAS, MODULO_ADMIN_INSTITUCIONES, MODULO_ADMIN_USUARIOS, MODULO_GESTION_ESTUDIANTES],
    RolCodigo.DIRECTOR: [
